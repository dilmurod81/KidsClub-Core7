...
{
    public partial class KidsClub_Core7Context : DbContext
    {
        public KidsClub_Core7Context()
        {
        }

        public KidsClub_Core7Context(DbContextOptions<KidsClub_Core7Context> options)
            : base(options)
        {
        }
